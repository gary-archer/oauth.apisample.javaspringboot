...
public class LogEntryImpl implements LogEntry {
    ...
    public void start(
        ...
        if (!this.started) {
            ...
            if (!StringUtils.isEmpty(callingApplicationName)) {
                this.data.setCallingApplicationName(callingApplicationName);
            }
    ...
    public void setIdentity(final CoreApiClaims claims) {
        this.data.setClientId(claims.getClientId());
        this.data.setUserId(claims.getUserId());
        this.data.setUserName(String.format("%s %s", claims.getGivenName(), claims.getFamilyName()));
    }
