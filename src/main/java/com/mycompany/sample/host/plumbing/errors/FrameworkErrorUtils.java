 ...
 */
public final class FrameworkErrorUtils {

    private FrameworkErrorUtils() {
    }
    ...
    public static Object fromException(final Throwable exception) {
        ...
        var apiError = FrameworkErrorUtils.tryConvertToApiError(exception);
        if (apiError != null) {
            return apiError;
        }

        var clientError = FrameworkErrorUtils.tryConvertToClientError(exception);
        if (clientError != null) {
            return clientError;
        }

        return FrameworkErrorUtils.createApiError(exception, null, null);
    }
    ...
    private static ApiError tryConvertToApiError(final Throwable ex) {
        ...
        if (ex instanceof ExtendedRuntimeException) {
            return FrameworkErrorUtils.fromExtendedRuntimeException((ExtendedRuntimeException) ex);
        }
        ...
        while (throwable != null) {
            ...
            if (throwable instanceof ExtendedRuntimeException) {
                return FrameworkErrorUtils.fromExtendedRuntimeException((ExtendedRuntimeException) throwable);
            }
