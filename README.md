...
Ensure that Java 13 and maven are installed, then run the start script to begin listening over HTTPS.\
...
* Java 13 and Spring Boot 2.6 are used to implement the REST API
